...
abstract class _DragGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  _DragGestureRecognizer({super.debugOwner});
...
class DirectionGestureRecognizer extends _DragGestureRecognizer {
  ...
  DirectionGestureRecognizer(this.direction, {super.debugOwner});
  ...
  bool _isFlingGesture(VelocityEstimate estimate) {
    ...
    if (_hasAll) {
      return estimate.pixelsPerSecond.distanceSquared > minVelocity && estimate.offset.distanceSquared > minDistance;
    } else {
      bool result = false;
      if (_hasVertical) {
        result |= estimate.pixelsPerSecond.dy.abs() > minVelocity && estimate.offset.dy.abs() > minDistance;
      }
      if (_hasHorizontal) {
        result |= estimate.pixelsPerSecond.dx.abs() > minVelocity && estimate.offset.dx.abs() > minDistance;
      }
      return result;
    }
  }
  ...
  @override
  String get debugDescription => 'orientation_$direction';
}
...
class IgnorePanGestureRecognizer extends _DragGestureRecognizer {
  ...
  IgnorePanGestureRecognizer(this.ignoreDirection, {super.debugOwner});
